...
urlpatterns = [
    ...
    path('filter/aktenzeichen/', views.aktenzeichen_filter_view, name='filter_aktenzeichen'),
    ...
    path('export/aktenzeichen/', views.export_aktenzeichen_view, name='export_aktenzeichen'),
]
